		...
		<div class="form-fields clear">
			...
			<input type="hidden" name="_srf" value="1">
				...
				<div class="form-group">
					...
					<select name="proptype" class="property form-control js-select2">
...
<script type="text/javascript">
	if (typeof jQuery == 'undefined') {
	    document.write('<scr' + 'ipt type="text/javascript" src="https://be21692d7e538797ce0b-6a2099bd7ee8af40c5ab172871c6b233.ssl.cf1.rackcdn.com/jquery-min.js"></scr' + 'ipt>');
	} else {
	// nothing
	}
</script>
  <script src="https://be21692d7e538797ce0b-6a2099bd7ee8af40c5ab172871c6b233.ssl.cf1.rackcdn.com/jquery.autocomplete.min.js" type="text/javascript"></script>
  <link href="https://be21692d7e538797ce0b-6a2099bd7ee8af40c5ab172871c6b233.ssl.cf1.rackcdn.com/jquery.autocomplete.css" rel="stylesheet" type="text/css" />
  <script src="https://img.localhomesearch.net/js/localdata.js" type="text/javascript"></script>
  <script src="https://img.localhomesearch.net/js/autosub_so.js" type="text/javascript"></script>
				...
				<input type="submit" value="Search" class="qsearch">
